...
var pos = [];
var fps;
var intro = "Uncompromised Ultra Efficient Turbine Power"
...
var scroller = {
	...
	scrollHeight: 0,
	scrollToPos: [],
	animationTimeScale: 1000, // px per second
	steps: [],
	step: 0,
	anim: 1,
	y: 0,
...
for (var i = 0; i < viewSteps.length; i++) {
	addStep(viewSteps[i], scroller.stepPadding, scroller.animationTimeScale, i);
}

gsap.set(virtualScrollContainer, {
	height: scroller.scrollHeight + scroller.viewportHeight
});

gsap.set(scroller.container, {
	height: scroller.scrollHeight, width: scroller.viewportWidth, 
	force3D: true
});

gsap.set(viewSteps, {
	height: scroller.viewportHeight, width: scroller.viewportWidth,
	force3D: true
});
